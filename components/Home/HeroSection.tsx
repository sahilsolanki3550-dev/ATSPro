  ...
  return (
    <section className='mx-auto grid grid-cols-2 '>
      ...
      <div className='space-y-5'>
        ...
        <h1 className='text-[80px] leading-20 font-black '><span className='text-white '>Beat the ATS.</span><br /><span className=' bg-clip-text text-transparent bg-linear-to-r from-primary to-purple-400'>Land More <br />Interviews.</span></h1>
      ...
      <div className='flex items-center justify-center opacity-80'>
        ...
        <div className='h-18 w-16 absolute -top-10 rounded-xl  -right-5 bg-[#171736] border border-blue-950 flex items-center justify-center'>
          ...
          <div className='grid grid-cols-12 gap-6'>
            {/* left */}
            <div className='col-span-6 bg-[#3B82F61A] rounded-2xl p-6 flex flex-col items-center border border-[#FFFFFF1A]'>
            ...
            {/* right */} 
            <div className=' col-span-6 space-y-3 borde'>
            ...
            {/* Ai Insight */}
            <div className='col-span-12 bg-[#3B82F61A] p-5 rounded-3xl space-y-2    '>
              <div><span className='uppercse text-white font-bold'>AI Insight</span></div>
              <ul className='space-y-2'>
                <li className='text-slate-300 flex gap-2 items-center'>
                  <div className='w-3.5 h-3.5  bg-green-500 rounded-full mt-1 flex items-center justify-center'><Check strokeWidth={3} size={10} color='black'/></div>
                  <p>Strong matches found for: Python, React, Cloud Architecture.</p>
                </li>
                <li className='text-slate-300 flex gap-2 items-center'>
                  <div className='h-3.5 w-3.5 bg-primary rounded-full mt-1 flex justify-center items-center'>
                    <Plus color='black' strokeWidth={3}/>
                  </div>
                  Recommendation: Add "Scalable Systems" to your summary.
                </li>
                <li className='text-slate-300 flex gap-2 items-center'>
                  <span className=' h-3.5 w-3.5 flex justify-center items-center'>
                    <TriangleAlert color='black' fill='yellow' />
                  </span>
