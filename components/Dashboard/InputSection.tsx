...
const InputSection = () => {
    ...
    return (
        <section className='px-20 py-10 bg-green-100 grid grid-cols-2 gap-5'>
            <div className='p-5 bg-[#14142a] rounded-4xl space-y-5 w-150'>
                <p className='text-white font-semibold'>Job Description</p>
            ...
            <div className='p-5 bg-[#14142a] rounded-lg space-y-5 w-150'>
                <h3>Result</h3>
